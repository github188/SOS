...
* #### 举例说明:
  ...
  输出结果：SangforTool.sh -w 1.1.1.1:4009 -u aes -p test -n 1.1.1.0 -m 255.255.255.0 -C A -s 1 -v 1.2.3.1 -t 0 -r 0 -M 1 -l 111.111.111.0 -d 255.255.255.0 -a 0 -L 0 -R 0 -c 1000
  ```
